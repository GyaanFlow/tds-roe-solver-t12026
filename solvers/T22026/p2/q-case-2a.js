...
export async function solve(email, sessionToken) {
  ...
  const rejectedVariants = [
    ...
    '"Since this is only a small sample, we should assume the worst and escalate to be safe." Rejected: escalation requires evidence of impact or an open fault, neither of which this file contains; the correct response to sparse data is a cheap completeness check, not a precautionary escalation.',
