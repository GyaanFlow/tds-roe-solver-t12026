// Solver: T2 2026 ROE Runtime Wrapper
...
export function wrapSolverModule(mod) {
  ...
  if (typeof id !== 'string' || !id) {
    throw new Error('ROE (T22026) solver module is missing a valid id.');
  }
  if (typeof title !== 'string' || !title) {
    throw new Error(`ROE (T22026) solver ${id} is missing a valid title.`);
  }
  if (typeof solveImpl !== 'function') {
    throw new Error(`ROE (T22026) solver ${id} is missing a solve(email) function.`);
  }
