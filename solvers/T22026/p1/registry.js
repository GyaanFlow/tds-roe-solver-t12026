// Solver Registry — T2 2026 Project 1 (all 5 questions)
...
import * as telegramBot from './q-telegram-bot.js';
...
export const solvers = [
  ...
  telegramBot            // Q5: Data Analyst Telegram Bot — guide (real bot + deployment)
