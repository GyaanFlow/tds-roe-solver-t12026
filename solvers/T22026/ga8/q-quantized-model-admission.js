...
function registerInteractive() {
  ...
  window._ga8Q5CopyUrl = async function () {
    ...
    const btn = document.getElementById('ga8Q5CopyBtn');
...
export async function solve(email) {
  ...
  const guide = [
    ...
    `    <button id="ga8Q5CopyBtn" type="button" onclick="window._ga8Q5CopyUrl()" class="btn-sm" style="padding:6px 12px;background:var(--theme-primary,#f59e0b);color:#111;border:none;border-radius:4px;font-weight:600;cursor:pointer;">Copy URL</button>`,
